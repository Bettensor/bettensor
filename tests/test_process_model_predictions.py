...
def test_process_model_predictions_with_mock_data(mock_predictions_handler):
    ...
    predictions = mock_predictions_handler.process_model_predictions(sample_games, "soccer")
    ...
    for game_id, prediction in predictions.items():
        ...
        print(f"Odds: {prediction.teamAodds}, {prediction.teamBodds}, {prediction.tieOdds}")
        print("---")
