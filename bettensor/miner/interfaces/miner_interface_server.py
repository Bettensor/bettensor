...
import threading
import time
from flask import Flask, request, jsonify, g, make_response, g, make_response
...
if __name__ == '__main__':
    ...
    parser.add_argument('--public', action='store_true', help='Run in public mode')
    ...
    if check_redis_connection():
        ...
        print(f"Starting Flask server on https://{args.host}:{args.port}")
        print("Warning: This server is using a self-signed certificate. You may see security warnings in your browser.")
        
        if args.public:
            print("Running in public mode")
            # Add any specific configurations for public mode here
